...
SubProceso magica(matriz,n)
	...
	mMagica=falso
	para i=0 Hasta n-1 Hacer
		si sumaFila(i)=sumaColumna(i) y sumaFila(i)=sumaDiagonal y sumaFila(i)=sumaDinvertida  Entonces
			mMagica=Verdadero			
		FinSi
	FinPara
	si mMagica=Falso Entonces
		Escribir "La matriz ingresada no es mágica."
	FinSi
	si mMagica=verdadero Entonces
