...
Algoritmo sin_titulo
	...
	Dimension matriz1(2,3) 
	Dimension matriz2(3,3) 
	Dimension matrizresultante(2,3)
	llenarmatriz(matriz1,2,3)
	llenarmatriz(matriz2,3,3)
	escribematriz(matriz1,2,3)
	escribir ""
	escribematriz(matriz2,3,3)
	escribir ""
	multiplicacion(matriz1,matriz2,2,3,3,3,matrizresultante)
	escribematriz(matrizresultante,2,3)
FinAlgoritmo
...
SubProceso multiplicacion(m1,m2,f1,c1,f2,c2,mr)
